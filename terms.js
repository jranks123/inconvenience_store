document.addEventListener('DOMContentLoaded', () => {
    ...
    const termsContent = `
        ...
        <p>The term 'Inconvenience Store' or 'us' or 'we' refers to the owner of the website whose registered office is Inconvenience Store, Boomtown. Our company registration number is 3498486993. The term 'you' refers to the user or viewer of our website.</p>
